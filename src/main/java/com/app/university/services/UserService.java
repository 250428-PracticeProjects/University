...
import com.app.university.exceptions.UserNotFoundException;
import com.app.university.models.User;
import com.app.university.repos.UserDAO;
import com.app.university.util.PasswordUtil;
...
public class UserService {
     ...
     *  
     */
    public Optional<UserDTO> login(User userCredentials) throws UserNotFoundException {
        ...
        if (!PasswordUtil.checkPassword(userToLogin.getPassword(), userCredentials.getPassword())) {
